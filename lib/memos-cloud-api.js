...
export function getConfigResolution(pluginConfig = {}) {
  const cfg = pluginConfig ?? {};
  const usesTruthyConfigValue = (key) => Boolean(cfg[key]);
  const usesNullishConfigValue = (key) => cfg[key] !== undefined && cfg[key] !== null;
  const resolved = buildConfig(cfg);

  const envRaw = {
    baseUrl: loadEnvVar("MEMOS_BASE_URL"),
    apiKey: loadEnvVar("MEMOS_API_KEY"),
    userId: loadEnvVar("MEMOS_USER_ID"),
    useDirectSessionUserId: loadEnvVar("MEMOS_USE_DIRECT_SESSION_USER_ID"),
    conversationId: loadEnvVar("MEMOS_CONVERSATION_ID"),
    recallGlobal: loadEnvVar("MEMOS_RECALL_GLOBAL"),
    conversationIdPrefix: loadEnvVar("MEMOS_CONVERSATION_PREFIX"),
    conversationIdSuffix: loadEnvVar("MEMOS_CONVERSATION_SUFFIX"),
    conversationSuffixMode: loadEnvVar("MEMOS_CONVERSATION_SUFFIX_MODE"),
    resetOnNew: loadEnvVar("MEMOS_CONVERSATION_RESET_ON_NEW"),
    multiAgentMode: loadEnvVar("MEMOS_MULTI_AGENT_MODE"),
    allowedAgents: loadEnvVar("MEMOS_ALLOWED_AGENTS"),
    recallFilterEnabled: loadEnvVar("MEMOS_RECALL_FILTER_ENABLED"),
    recallFilterFailOpen: loadEnvVar("MEMOS_RECALL_FILTER_FAIL_OPEN"),
    captureStrategy: loadEnvVar("MEMOS_CAPTURE_STRATEGY"),
    asyncMode: loadEnvVar("MEMOS_ASYNC_MODE"),
    throttleMs: loadEnvVar("MEMOS_THROTTLE_MS"),
    includeAssistant: loadEnvVar("MEMOS_INCLUDE_ASSISTANT"),
    maxMessageChars: loadEnvVar("MEMOS_MAX_MESSAGE_CHARS"),
    relativity: loadEnvVar("MEMOS_RELATIVITY"),
    recallFilterBaseUrl: loadEnvVar("MEMOS_RECALL_FILTER_BASE_URL"),
    recallFilterApiKey: loadEnvVar("MEMOS_RECALL_FILTER_API_KEY"),
    recallFilterModel: loadEnvVar("MEMOS_RECALL_FILTER_MODEL"),
    recallFilterTimeoutMs: loadEnvVar("MEMOS_RECALL_FILTER_TIMEOUT_MS"),
    recallFilterRetries: loadEnvVar("MEMOS_RECALL_FILTER_RETRIES"),
    recallFilterCandidateLimit: loadEnvVar("MEMOS_RECALL_FILTER_CANDIDATE_LIMIT"),
    recallFilterMaxItemChars: loadEnvVar("MEMOS_RECALL_FILTER_MAX_ITEM_CHARS"),
    agentOverrides: loadEnvVar("MEMOS_AGENT_OVERRIDES"),
  };

  const fieldMeta = {
    baseUrl: { source: usesTruthyConfigValue("baseUrl") ? "config" : envRaw.baseUrl ? "env" : "default", inheritedValue: resolved.baseUrl, uiDefaultValue: DEFAULT_BASE_URL },
    apiKey: { source: usesTruthyConfigValue("apiKey") ? "config" : envRaw.apiKey ? "env" : "empty", inheritedValue: envRaw.apiKey ?? "", uiDefaultValue: undefined },
    userId: { source: usesTruthyConfigValue("userId") ? "config" : envRaw.userId ? "env" : "default", inheritedValue: resolved.userId, uiDefaultValue: "openclaw-user" },
    useDirectSessionUserId: { source: usesNullishConfigValue("useDirectSessionUserId") ? "config" : envRaw.useDirectSessionUserId !== undefined ? "env" : "default", inheritedValue: resolved.useDirectSessionUserId, uiDefaultValue: false },
    conversationId: { source: usesTruthyConfigValue("conversationId") ? "config" : envRaw.conversationId ? "env" : "empty", inheritedValue: resolved.conversationId, uiDefaultValue: undefined },
    conversationIdPrefix: { source: usesNullishConfigValue("conversationIdPrefix") ? "config" : envRaw.conversationIdPrefix !== undefined ? "env" : "empty", inheritedValue: resolved.conversationIdPrefix, uiDefaultValue: undefined },
    conversationIdSuffix: { source: usesNullishConfigValue("conversationIdSuffix") ? "config" : envRaw.conversationIdSuffix !== undefined ? "env" : "empty", inheritedValue: resolved.conversationIdSuffix, uiDefaultValue: undefined },
    conversationSuffixMode: { source: usesNullishConfigValue("conversationSuffixMode") ? "config" : envRaw.conversationSuffixMode ? "env" : "default", inheritedValue: resolved.conversationSuffixMode, uiDefaultValue: "none" },
    resetOnNew: { source: usesNullishConfigValue("resetOnNew") ? "config" : envRaw.resetOnNew !== undefined ? "env" : "default", inheritedValue: resolved.resetOnNew, uiDefaultValue: true },
    queryPrefix: { source: usesNullishConfigValue("queryPrefix") ? "config" : "empty", inheritedValue: "", uiDefaultValue: undefined },
    maxQueryChars: { source: usesNullishConfigValue("maxQueryChars") ? "config" : "default", inheritedValue: resolved.maxQueryChars, uiDefaultValue: 0 },
    recallEnabled: { source: usesNullishConfigValue("recallEnabled") ? "config" : "default", inheritedValue: resolved.recallEnabled, uiDefaultValue: true },
    recallGlobal: { source: usesNullishConfigValue("recallGlobal") ? "config" : envRaw.recallGlobal !== undefined ? "env" : "default", inheritedValue: resolved.recallGlobal, uiDefaultValue: true },
    maxItemChars: { source: usesNullishConfigValue("maxItemChars") ? "config" : "default", inheritedValue: resolved.maxItemChars, uiDefaultValue: 8000 },
    memoryLimitNumber: { source: usesNullishConfigValue("memoryLimitNumber") ? "config" : "default", inheritedValue: resolved.memoryLimitNumber, uiDefaultValue: 9 },
    preferenceLimitNumber: { source: usesNullishConfigValue("preferenceLimitNumber") ? "config" : "default", inheritedValue: resolved.preferenceLimitNumber, uiDefaultValue: 6 },
    includePreference: { source: usesNullishConfigValue("includePreference") ? "config" : "default", inheritedValue: resolved.includePreference, uiDefaultValue: true },
    includeToolMemory: { source: usesNullishConfigValue("includeToolMemory") ? "config" : "default", inheritedValue: resolved.includeToolMemory, uiDefaultValue: false },
    toolMemoryLimitNumber: { source: usesNullishConfigValue("toolMemoryLimitNumber") ? "config" : "default", inheritedValue: resolved.toolMemoryLimitNumber, uiDefaultValue: 6 },
    relativity: { source: usesNullishConfigValue("relativity") ? "config" : envRaw.relativity !== undefined ? "env" : "default", inheritedValue: resolved.relativity, uiDefaultValue: 0.45 },
    filter: { source: usesNullishConfigValue("filter") ? "config" : "empty", inheritedValue: undefined, uiDefaultValue: undefined },
    knowledgebaseIds: { source: usesNullishConfigValue("knowledgebaseIds") ? "config" : "default", inheritedValue: resolved.knowledgebaseIds, uiDefaultValue: [] },
    addEnabled: { source: usesNullishConfigValue("addEnabled") ? "config" : "default", inheritedValue: resolved.addEnabled, uiDefaultValue: true },
    captureStrategy: { source: usesNullishConfigValue("captureStrategy") ? "config" : envRaw.captureStrategy ? "env" : "default", inheritedValue: resolved.captureStrategy, uiDefaultValue: "last_turn" },
    maxMessageChars: { source: usesNullishConfigValue("maxMessageChars") ? "config" : envRaw.maxMessageChars !== undefined ? "env" : "default", inheritedValue: resolved.maxMessageChars, uiDefaultValue: 20000 },
    includeAssistant: { source: usesNullishConfigValue("includeAssistant") ? "config" : envRaw.includeAssistant !== undefined ? "env" : "default", inheritedValue: resolved.includeAssistant, uiDefaultValue: true },
    tags: { source: usesNullishConfigValue("tags") ? "config" : "default", inheritedValue: resolved.tags, uiDefaultValue: ["openclaw"] },
    info: { source: usesNullishConfigValue("info") ? "config" : "default", inheritedValue: resolved.info, uiDefaultValue: {} },
    asyncMode: { source: usesNullishConfigValue("asyncMode") ? "config" : envRaw.asyncMode !== undefined ? "env" : "default", inheritedValue: resolved.asyncMode, uiDefaultValue: true },
    agentId: { source: usesNullishConfigValue("agentId") ? "config" : "empty", inheritedValue: undefined, uiDefaultValue: undefined },
    multiAgentMode: { source: usesNullishConfigValue("multiAgentMode") ? "config" : envRaw.multiAgentMode !== undefined ? "env" : "default", inheritedValue: resolved.multiAgentMode, uiDefaultValue: false },
    allowedAgents: { source: usesNullishConfigValue("allowedAgents") ? "config" : envRaw.allowedAgents !== undefined ? "env" : "default", inheritedValue: resolved.allowedAgents, uiDefaultValue: [] },
    agentOverrides: { source: usesNullishConfigValue("agentOverrides") ? "config" : envRaw.agentOverrides !== undefined ? "env" : "default", inheritedValue: resolved._agentOverrides, uiDefaultValue: {} },
    appId: { source: usesNullishConfigValue("appId") ? "config" : "empty", inheritedValue: undefined, uiDefaultValue: undefined },
    allowPublic: { source: usesNullishConfigValue("allowPublic") ? "config" : "default", inheritedValue: resolved.allowPublic, uiDefaultValue: false },
    allowKnowledgebaseIds: { source: usesNullishConfigValue("allowKnowledgebaseIds") ? "config" : "default", inheritedValue: resolved.allowKnowledgebaseIds, uiDefaultValue: [] },
    recallFilterEnabled: { source: usesNullishConfigValue("recallFilterEnabled") ? "config" : envRaw.recallFilterEnabled !== undefined ? "env" : "default", inheritedValue: resolved.recallFilterEnabled, uiDefaultValue: false },
    recallFilterBaseUrl: { source: usesNullishConfigValue("recallFilterBaseUrl") ? "config" : envRaw.recallFilterBaseUrl !== undefined ? "env" : "empty", inheritedValue: resolved.recallFilterBaseUrl, uiDefaultValue: undefined },
    recallFilterApiKey: { source: usesNullishConfigValue("recallFilterApiKey") ? "config" : envRaw.recallFilterApiKey !== undefined ? "env" : "empty", inheritedValue: resolved.recallFilterApiKey, uiDefaultValue: undefined },
    recallFilterModel: { source: usesNullishConfigValue("recallFilterModel") ? "config" : envRaw.recallFilterModel !== undefined ? "env" : "empty", inheritedValue: resolved.recallFilterModel, uiDefaultValue: undefined },
    recallFilterTimeoutMs: { source: usesNullishConfigValue("recallFilterTimeoutMs") ? "config" : envRaw.recallFilterTimeoutMs !== undefined ? "env" : "default", inheritedValue: resolved.recallFilterTimeoutMs, uiDefaultValue: 6000 },
    recallFilterRetries: { source: usesNullishConfigValue("recallFilterRetries") ? "config" : envRaw.recallFilterRetries !== undefined ? "env" : "default", inheritedValue: resolved.recallFilterRetries, uiDefaultValue: 0 },
    recallFilterCandidateLimit: { source: usesNullishConfigValue("recallFilterCandidateLimit") ? "config" : envRaw.recallFilterCandidateLimit !== undefined ? "env" : "default", inheritedValue: resolved.recallFilterCandidateLimit, uiDefaultValue: 30 },
    recallFilterMaxItemChars: { source: usesNullishConfigValue("recallFilterMaxItemChars") ? "config" : envRaw.recallFilterMaxItemChars !== undefined ? "env" : "default", inheritedValue: resolved.recallFilterMaxItemChars, uiDefaultValue: 500 },
    recallFilterFailOpen: { source: usesNullishConfigValue("recallFilterFailOpen") ? "config" : envRaw.recallFilterFailOpen !== undefined ? "env" : "default", inheritedValue: resolved.recallFilterFailOpen, uiDefaultValue: true },
    timeoutMs: { source: usesNullishConfigValue("timeoutMs") ? "config" : "default", inheritedValue: resolved.timeoutMs, uiDefaultValue: 5000 },
    retries: { source: usesNullishConfigValue("retries") ? "config" : "default", inheritedValue: resolved.retries, uiDefaultValue: 1 },
    throttleMs: { source: usesNullishConfigValue("throttleMs") ? "config" : envRaw.throttleMs !== undefined ? "env" : "default", inheritedValue: resolved.throttleMs, uiDefaultValue: 0 },
  };
