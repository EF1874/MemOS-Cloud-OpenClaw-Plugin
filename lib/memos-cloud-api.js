...
export function buildConfig(pluginConfig = {}) {
  ...
  return {
    ...
    includeSkill: cfg.includeSkill === true,
    skillLimitNumber: cfg.skillLimitNumber ?? 6,
...
const AGENT_OVERRIDABLE_KEYS = [
  ...
  "includeSkill", "skillLimitNumber", "relativity", "filter",
  "recallEnabled", "addEnabled", "captureStrategy", "queryPrefix",
  "maxQueryChars", "maxItemChars", "maxMessageChars", "includeAssistant",
